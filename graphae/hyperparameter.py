...
def add_arguments(parser):
    ...
    parser.add_argument("--graph_encoder_hidden_dim", default=2048, type=int)
    ...
    parser.add_argument("--meta_node_decoder_hidden_dim", default=4096, type=int)
    parser.add_argument("--meta_node_decoder_num_layers", default=6, type=int)
